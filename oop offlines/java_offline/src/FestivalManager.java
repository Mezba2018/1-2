...
public class FestivalManager {
    ...
    public void showEventsOnDate(String eventDate) {
        ...
        if(count==0){
            System.out.println("No events on date " + eventDate);
        }
    ...
    public void showEventsForStudent(String studentId) {
        ...
        for(i=0;i<eventsAdded;i++)
        {
            if(events[i].isRegistered(studentId)){
                System.out.println("Name: " + events[i].geteventName());
        ...
        if (count==0) {
            System.out.println("No events found for student " + studentId);
        }
    }
